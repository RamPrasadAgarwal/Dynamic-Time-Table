...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2016 at 09:48 AM
...
('2016-11-23', 'WEDNESDAY', 'NULL', 'NULL', 'OS', 'LAB', 'LAB', 'LAB', 'CG', 'AMP', 'SS'),
('2016-11-24', 'THURSDAY', 'NULL', 'NULL', 'SS', 'DBMS', 'AMP', 'SS', 'NULL', 'NULL', 'NULL'),
('2016-11-25', 'FRIDAY', 'NULL', 'NULL', 'CG', 'CD', 'AMP', 'OS', 'SS', 'DBMS', 'NULL'),
...
('2016-11-20', 'SUNDAY', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL'),
('2016-11-21', 'MONDAY', 'NULL', 'NULL', 'DUOS', 'AMP', 'SS', 'DBMS', 'OS', 'NULL', 'CD'),
...
('2016-11-25', 'FRIDAY', 'NULL', 'NULL', 'class5a', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL'),
...
('2016-11-23', 'WEDNESDAY', 'NULL', 'NULL', 'class5a', 'class5b', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL'),
...
('2016-11-24', 'THURSDAY', 'NULL', 'NULL', 'class5a', 'NULL', 'NULL', 'class5a', 'NULL', 'NULL', 'NULL'),
...
('2016-11-20', 'SUNDAY', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL'),
('2016-11-21', 'MONDAY', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'class5a', 'NULL', 'NULL', 'class5b'),
...
('2016-11-24', 'THURSDAY', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL'),
('2016-11-25', 'FRIDAY', 'NULL', 'NULL', 'NULL', 'class5a', 'NULL', 'class5b', 'NULL', 'NULL', 'NULL'),
...
('2016-11-24', 'THURSDAY', 'NULL', 'NULL', 'NULL', 'NULL', 'class5a', 'NULL', 'NULL', 'class5b', 'NULL'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `ambili`  AS  select `tr_ambili`.`Date` AS `Date`,`tr_ambili`.`Day` AS `Day`,`tr_ambili`.`t1` AS `t1`,`tr_ambili`.`t2` AS `t2`,`tr_ambili`.`t3` AS `t3`,`tr_ambili`.`t4` AS `t4`,`tr_ambili`.`t5` AS `t5`,`tr_ambili`.`t6` AS `t6`,`tr_ambili`.`t7` AS `t7`,`tr_ambili`.`t8` AS `t8`,`tr_ambili`.`t9` AS `t9` from `tr_ambili` order by `tr_ambili`.`Date` desc limit 7 ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `anita`  AS  select `tr_anita`.`Date` AS `Date`,`tr_anita`.`Day` AS `Day`,`tr_anita`.`t1` AS `t1`,`tr_anita`.`t2` AS `t2`,`tr_anita`.`t3` AS `t3`,`tr_anita`.`t4` AS `t4`,`tr_anita`.`t5` AS `t5`,`tr_anita`.`t6` AS `t6`,`tr_anita`.`t7` AS `t7`,`tr_anita`.`t8` AS `t8`,`tr_anita`.`t9` AS `t9` from `tr_anita` order by `tr_anita`.`Date` desc limit 7 ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `lokesh`  AS  select `tr_lokesh`.`Date` AS `Date`,`tr_lokesh`.`Day` AS `Day`,`tr_lokesh`.`t1` AS `t1`,`tr_lokesh`.`t2` AS `t2`,`tr_lokesh`.`t3` AS `t3`,`tr_lokesh`.`t4` AS `t4`,`tr_lokesh`.`t5` AS `t5`,`tr_lokesh`.`t6` AS `t6`,`tr_lokesh`.`t7` AS `t7`,`tr_lokesh`.`t8` AS `t8`,`tr_lokesh`.`t9` AS `t9` from `tr_lokesh` order by `tr_lokesh`.`Date` desc limit 7 ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `madan`  AS  select `tr_madan`.`Date` AS `Date`,`tr_madan`.`Day` AS `Day`,`tr_madan`.`t1` AS `t1`,`tr_madan`.`t2` AS `t2`,`tr_madan`.`t3` AS `t3`,`tr_madan`.`t4` AS `t4`,`tr_madan`.`t5` AS `t5`,`tr_madan`.`t6` AS `t6`,`tr_madan`.`t7` AS `t7`,`tr_madan`.`t8` AS `t8`,`tr_madan`.`t9` AS `t9` from `tr_madan` order by `tr_madan`.`Date` desc limit 7 ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `phaneendra`  AS  select `tr_phan`.`Date` AS `Date`,`tr_phan`.`Day` AS `Day`,`tr_phan`.`t1` AS `t1`,`tr_phan`.`t2` AS `t2`,`tr_phan`.`t3` AS `t3`,`tr_phan`.`t4` AS `t4`,`tr_phan`.`t5` AS `t5`,`tr_phan`.`t6` AS `t6`,`tr_phan`.`t7` AS `t7`,`tr_phan`.`t8` AS `t8`,`tr_phan`.`t9` AS `t9` from `tr_phan` order by `tr_phan`.`Date` desc limit 7 ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `yuvraju`  AS  select `tr_yuvraju`.`Date` AS `Date`,`tr_yuvraju`.`Day` AS `Day`,`tr_yuvraju`.`t1` AS `t1`,`tr_yuvraju`.`t2` AS `t2`,`tr_yuvraju`.`t3` AS `t3`,`tr_yuvraju`.`t4` AS `t4`,`tr_yuvraju`.`t5` AS `t5`,`tr_yuvraju`.`t6` AS `t6`,`tr_yuvraju`.`t7` AS `t7`,`tr_yuvraju`.`t8` AS `t8`,`tr_yuvraju`.`t9` AS `t9` from `tr_yuvraju` order by `tr_yuvraju`.`Date` desc limit 7 ;
